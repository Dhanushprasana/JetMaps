...
class UserPage2 extends StatefulWidget {
  const UserPage2({Key? key});

  @override
  State<UserPage2> createState() => _UserPageState2();
}

class _UserPageState2 extends State<UserPage2> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: Text('Raise An Issue',style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                          ),
                        ),
                      ],
                    ),
